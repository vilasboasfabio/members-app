...
function CardCadastro({ restaurante, abrirDetalhes, editarRestaurante, excluirRestaurante }) {
    ...
    <TouchableOpacity style={styles.card} onPress={() => abrirDetalhes(restaurante.restaurantid)}>
      ...
      <View style={styles.content}>
        ...
        <View style={styles.typeContainer}>
          <Text style={styles.type}>{restaurante.cuisinetype}</Text>
        </View>
        <View style={styles.buttonContainer}>
          <TouchableOpacity onPress={() => editarRestaurante(restaurante.restaurantid)}>
            <MaterialIcons name="edit" size={24} color="#daa520" />
          </TouchableOpacity>
          <TouchableOpacity onPress={() => excluirRestaurante(restaurante.restaurantid)}>
            <MaterialIcons name="delete" size={24} color="#daa520" />
          </TouchableOpacity>
        </View>
      </View>
    </TouchableOpacity>
